/** Country dial codes for AppPhoneField (ISO 3166-1 alpha-2). */
export const DIAL_CODES = [
  ...
  { iso2: "bq", name: "Caribbean Netherlands", dialCode: "599" },
...
const byIso = Object.fromEntries(DIAL_CODES.map((c) => [c.iso2, c]));

export const getCountryByIso = (iso2 = "") => byIso[String(iso2).toLowerCase()] || null;

export const findCountryForNumber = (raw = "") => {
