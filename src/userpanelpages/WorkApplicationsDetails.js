...
const WorkApplicationsDetails = () => {
  ...
  if (loading) {
    return (
      <ProtectedPageLayout fullName={fullName} userId={userId} title="Work Application Details">
    ...
    return (
      <ProtectedPageLayout fullName={fullName} userId={userId} title="Work Application Details">
        <Alert
          severity="error"
          action={
            <Button component={RouterLink} to="/work-applications" color="inherit" size="small">
  ...
  const detailRows = [
    ...
    { label: "Designation", value: application.designation || "N/A" },
    { label: "Work Experience", value: application.work_experience || "N/A" },
    ...
    { label: "Resume", value: application.resume || "N/A" },
    { label: "Cover Letter", value: application.cover_letter || "N/A" },
      ...
      <Stack spacing={2.5}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5}>
          ...
          {application.status === "Pending" ? (
            <Button
              component={RouterLink}
              to={`/edit-work-application/${application.id}`}
              variant="outlined"
              color="secondary"
              sx={{ textTransform: "none", borderRadius: "50px", fontWeight: 600 }}
            >
